...
public class AdapterTeams extends RecyclerView.Adapter<com.example.pas_11rpl1_beni.AdapterTeams.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.pas_11rpl1_beni.AdapterTeams.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final com.example.pas_11rpl1_beni.AdapterTeams.MyViewHolder holder, final int position) {
