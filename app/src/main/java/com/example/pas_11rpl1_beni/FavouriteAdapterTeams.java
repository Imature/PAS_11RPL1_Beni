...
public class FavouriteAdapterTeams extends RecyclerView.Adapter<com.example.pas_11rpl1_beni.FavouriteAdapterTeams.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.pas_11rpl1_beni.FavouriteAdapterTeams.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
