...
public class ListTeams extends AppCompatActivity {
    ...
    private ArrayList<ModelTeams> DataArrayList;
                        ...
                        try {
                            ...
                            adapter = new AdapterTeams(DataArrayList, new AdapterTeams.Callback() {
                                ...
                                public void onClick(int position) {
                                    ...
                                    Toast.makeText(com.example.pas_11rpl1_beni.ListTeams.this, "" + position, Toast.LENGTH_LONG);
                                }
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.example.pas_11rpl1_beni.ListTeams.this);
